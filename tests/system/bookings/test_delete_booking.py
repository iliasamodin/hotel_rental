...
from app.core.services.authorization.helpers import get_password_hash, get_access_token
from app.core.services.authorization.schemas import UserResponseSchema
...
class TestDeleteBooking:
    """
    System tests for DELETE method of endpoint /bookings/{booking_id}.
    """
